// Chen Qianyu body skin: validated visual chain with MMD native edge geometry.
// Runtime revision: 2026-08-05 restore material-only skin lighting.
// Material 9 (Skin) is the sole intended target in ChenQianyu_Endfield.emm.
