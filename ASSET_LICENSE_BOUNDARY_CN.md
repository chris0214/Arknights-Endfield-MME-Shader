...
- `EndfieldMME/internal/**`：项目原创/独立重写 Shader 源码，MIT。
- `EndfieldMME/controller/*.pmx`：项目生成的单三角面控制器，MIT。
- `EndfieldMME/textures/environment_presets/*.dds`：由用户提供的 CC0 HDR 转换；清单见 `manifest.json`。
